...
def add_application(application: ApplicationModel, 
    ...
    new_app = Application(
        ...
        date_applied=date.today(),  # Example timestamp for when the application was created, which can be used for tracking and sorting applications based on their creation time in the future when we implement a database and more advanced features
